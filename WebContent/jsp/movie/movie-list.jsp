...
// PreparedStatement : sql을 미리 기억하고있음 
// Statement : 그때그때 sql을 입력해준다
...
while(rs.next()){
	...
	out.println("<td><a href =\"/bdi-web/jsp/movie/movie-delete.jsp"
			+ "?mi_num=" + rs.getString("mi_num") + "\"><button>삭제</button></td>");
	out.println("</tr>");
}
%>
</table>
